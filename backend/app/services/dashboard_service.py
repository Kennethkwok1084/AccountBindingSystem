...
from ..models import AlertRecord, CurrentBinding, ExportJob, MobileAccount, OperationBatch


def dashboard_summary():
    return {
        "available_accounts": MobileAccount.query.filter_by(status="available").count(),
